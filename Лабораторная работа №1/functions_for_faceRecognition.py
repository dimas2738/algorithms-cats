...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('recognizer/recognition_by_photo_with OpenCV/HaarCascade/haarcascade_frontalface_default.xml')#Load haar classifier
...
#     cv2.putText(test_img,text,(x,y),cv2.FONT_HERSHEY_DUPLEX,2,(255, 176, 0),4)

def put_text(test_img,text,x,y):
        font = cv2.FONT_HERSHEY_DUPLEX
        cv2.putText(test_img, text, (x,y), font, 1.0, (255, 255, 255), 2)
