...
image = cv2.imread('recognizer/detect_by_photo/input/people.jpg')
...
if faces_boxes:
    ...
    for face_box in faces_boxes:
        ...
        if face_box['confidence'] > 0.99:  # 0.99 - уверенность сети в процентах что это лицо
            ...
            face_path = 'recognizer/detect_by_photo/output/selected/' + face_file_name
            ...
            face_path = 'recognizer/detect_by_photo/output/rejected/' + face_file_name
    ...
    cv2.imwrite('recognizer/detect_by_photo/output/people-detected.jpg', image_detected)

    # Сохранение исходного изображения с точками
    cv2.imwrite('recognizer/detect_by_photo/output/people-marked.jpg', image_marked)