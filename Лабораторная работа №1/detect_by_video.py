...
# Загрузка видео
capture = cv2.VideoCapture('recognizer/detect_video/input/test.mp4')
...
while True:
    ...
    if success:
        ...
        if faces_boxes:
            ...
            for face_box in faces_boxes:
                ...
                if face_box['confidence'] > 0.99:  # 0.99 - уверенность сети в процентах что это лицо
                    ...
                    face_path = 'recognizer/detect_video/output/faces/selected/' + face_file_name
                    ...
                    face_path = 'recognizer/detect_video/output/faces/rejected/' + face_file_name
        ...
        cv2.imwrite('recognizer/detect_video/output/frames/' + str(frame_id) + '.jpg', image_detected)
